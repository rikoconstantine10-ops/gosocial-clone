      ...
      />
        ...
        <div className="container-custom">
          ...
          <Link href="/service/digital-campaign/instagram-ads" className="glass p-5 rounded-2xl hover:scale-105 transition-transform duration-300 group block">
            ...
            <div className="text-xs text-muted-foreground">Khusus iklan Instagram</div>
          </Link>
          <Link href="/service/digital-campaign/facebook-ads" className="glass p-5 rounded-2xl hover:scale-105 transition-transform duration-300 group block">
            <div className="font-semibold text-sm mb-1 group-hover:text-primary transition-colors">Facebook Ads</div>
            <div className="text-xs text-muted-foreground">Iklan Facebook yang presisi</div>
          </Link>
          <Link href="/service/digital-campaign/tiktok-ads" className="glass p-5 rounded-2xl hover:scale-105 transition-transform duration-300 group block">
            ...
            <div className="text-xs text-muted-foreground">Platform video dengan engagement tinggi</div>
          </Link>
