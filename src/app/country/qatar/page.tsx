            ...
            <AnimateOnScroll>
              <div className="text-center mb-10">
                <h2 className="text-2xl lg:text-3xl font-bold mb-3" style={{ fontFamily: "var(--font-display)" }}>
                  City-Specific Services in <span className="text-gradient">Qatar</span>
                </h2>
                <p style={{ color: "var(--color-muted-foreground)" }}>Digital marketing services tailored for Indonesian businesses in Qatar&apos;s key cities.</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-xl mx-auto">
                {[
                  { city: "Doha", href: "/country/qatar/doha" },
                ].map((c) => (
