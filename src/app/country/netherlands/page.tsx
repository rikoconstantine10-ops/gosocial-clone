            ...
            <AnimateOnScroll>
              <div className="text-center mb-10">
                <h2 className="text-2xl lg:text-3xl font-bold mb-3" style={{ fontFamily: "var(--font-display)" }}>
                  City-Specific Services in the <span className="text-gradient">Netherlands</span>
                </h2>
                <p className="text-[var(--color-muted-foreground)]">Hyper-local digital marketing for Amsterdam, Rotterdam, and Den Haag</p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  { city: "Amsterdam", href: "/country/netherlands/amsterdam" },
                  { city: "Rotterdam", href: "/country/netherlands/rotterdam" },
                  { city: "Den Haag", href: "/country/netherlands/den-haag" },
                ].map((c) => (
