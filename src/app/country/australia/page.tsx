            ...
            <AnimateOnScroll>
              <div className="text-center mb-10">
                <h2 className="text-2xl lg:text-3xl font-bold mb-3" style={{ fontFamily: "var(--font-display)" }}>
                  City-Specific Services in <span className="text-gradient">Australia</span>
                </h2>
                <p className="text-[var(--color-muted-foreground)]">Hyper-local digital marketing for every major Australian city</p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  { city: "Sydney", href: "/country/australia/sydney" },
                  { city: "Melbourne", href: "/country/australia/melbourne" },
                  { city: "Perth", href: "/country/australia/perth" },
                  { city: "Brisbane", href: "/country/australia/brisbane" },
                ].map((c) => (
